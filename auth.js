...
function seedData() {
  ...
  const staffDefs = [
    { name: 'Sam Carter', email: 'sam@pub.local', position: 'Bartender', rate: 11.75, holiday: 28 },
    { name: 'Priya Shah', email: 'priya@pub.local', position: 'Bar Supervisor', rate: 13.25, holiday: 28 },
    { name: 'Tom Wallace', email: 'tom@pub.local', position: 'Kitchen', rate: 12.0, holiday: 28 },
    { name: 'Ella Brennan', email: 'ella@pub.local', position: 'Bartender', rate: 11.75, holiday: 20 },
  ];
